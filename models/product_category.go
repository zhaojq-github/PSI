...
type ProductCategory struct {
	...
	Sequence       int64              `form:"Sequence"`                                    //序列
	ParentFullPath string             `orm:"-"`                                            //上级全路径

	ParentID int64 `orm:"-" json:"Parent" form:"Parent"` //上级类
...
func AddProductCategory(obj *ProductCategory, addUser *User) (id int64, err error) {
	...
	if obj.ParentID > 0 {
		obj.Parent = new(ProductCategory)
...
func UpdateProductCategory(obj *ProductCategory, updateUser *User) (id int64, err error) {
	o := orm.NewOrm()
