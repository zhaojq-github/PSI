...
type Sequence struct {
	...
	Name       string    `orm:"unique" json:"Name" form:"Name"`                  //序号名称
	Prefix     string    `orm:"unique" json:"Prefix" form:"Prefix"`              //序号前缀
	Current    int64     `json:"Current" form:"Current"`                         //当前序号
	Padding    int64     `orm:"default(8)" json:"Padding" form:"Padding"`        //序列位数
	StructName string    `json:"StructName" form:"StructName"`                   //表struct名称
	Active     bool      `orm:"default(true)" json:"Active" form:"Active"`       //有效
	IsDefault  bool      `orm:"default(true)" json:"IsDefault" form:"IsDefault"` //默认
...
// UpdateSequence updates Sequence by ID and returns error if
// the record to be updated doesn't exist
func UpdateSequence(obj *Sequence, updateUser *User) (id int64, err error) {
	o := orm.NewOrm()
	obj.UpdateUser = updateUser

	updateFields := []string{"UpdateUser", "UpdateDate", "Name", "Company", "Prefix", "Current", "Padding", "StructName", "Active", "IsDefault"}
