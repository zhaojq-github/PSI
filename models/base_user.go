...
type User struct {
	...
	DepartmentID int64              `orm:"-" json:"Department" form:"Department"`
	CompanyID    int64              `orm:"-" json:"Company" form:"Company"`
	PositionID   int64              `orm:"-" json:"Position" form:"Position"`
...
func UpdateUser(obj *User, updateUser *User) (err error) {
	...
	updateFields := []string{"UpdateUser", "UpdateDate", "Name",
		"NameZh", "Company", "Department", "Email", "Mobile", "Tel", "IsAdmin", "Active",
		"Qq", "WeChat", "Position"}
